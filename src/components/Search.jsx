  ...
  return (
    <div className="p-2 bg-white rounded-md flex flex-row gap-1 px-2 items-center w-full relative">
      ...
      <Select className="inline-flex w-36">
        <SelectTrigger className="w-full outline-none border border-gray-300 shadow-none text-xs sm:text-sm p-0.5 sm:p-2 truncate">
      ...
      {/* Search Button */}
      <div className="text-sm sm:text-base bg-blue-900 text-white p-0.5 sm:p-2 rounded-full flex items-center justify-center cursor-pointer hover:bg-primary/80 transition-all duration-200 ease-in-out">
        <CiSearch />
      </div>
    </div>
  );
