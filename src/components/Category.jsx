...
function Category() {
  return (
    <div className="p-4 sm:p-10 py-2 gap-4 sm:gap-6 h-auto w-full -mt-10 ">
      <h2 className="font-bold text-lg sm:text-2xl md:text-3xl text-center mb-4 sm:mb-6 mt-5">
        Browse By Category
      </h2>
      <div className="flex flex-row gap-2 px-2 sm:px-20 overflow-x-auto justify-start sm:justify-center snap-x snap-mandatory pb-2">
